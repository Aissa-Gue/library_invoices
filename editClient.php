            ...
            <form action="editClient.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control text-center" value="<?php echo $client_id ?>"
                ...
                <div class="row mt-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" pattern="[0-9]*" class=" form-control" value="<?php echo $phone1 ?>"
                ...
                <div class="row mt-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" pattern="[0-9]*" class="form-control" value="<?php echo $phone2 ?>"
