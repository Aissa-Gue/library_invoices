    ...
    <form action="editOrder.php" method="post" enctype="multipart/form-data">
        ...
        <div class="row mt-3">
            <div class="col-md-2 ">
                ...
                <input type="number" class="form-control text-center" value="<?php echo $order_id ?>" name="order_id"
                    id="order_id" disabled>
                <input type="number" class="form-control text-center" value="<?php echo $order_id ?>" name="prev_id"
                    hidden>
            </div>
        ...
        <div class="row mt-3">
            <div class="col-md-5">
                ...
                <input type="text" class="form-control"
                    value="<?php echo $last_name . ' ' . $first_name . ' بن ' . $father_name ?>" name="client_id"
