        ...
        <form action="editOrder.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                <div class="col-md-2 ">
                    ...
                    <input type="number" class="form-control text-center" value="<?php echo $order_id ?>" name="order_id" id="order_id" disabled>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" value="<?php echo '% ' . $discount_percentage ?>" name="discount_percentage" id="discount_percentage" disabled>
                </div>
...
while ($row = mysqli_fetch_array($ordersBooksResult)) {
    ...
    ?>
                <div class="row mt-1">
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="title" id="title" value="<?php echo $row['title']; ?>" disabled>
                    </div>

                    <div class="col-md-2">
                        <input type="number" class="form-control" name="purchase_price" id="purchase_price" value="<?php echo $row['purchase_price']; ?>" disabled>
                    </div>
                    <div class="col-md-2">
                        <input type="number" class="form-control" name="sale_price" id="sale_price" value="<?php echo $row['sale_price']; ?>" disabled>
                    </div>

                    <div class="col-md-1">
                        <input type="number" class="form-control" name="quantity" id="quantity" value="<?php echo $row['quantity']; ?>" disabled>
                    </div>
