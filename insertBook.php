...
if (isset($_POST['insertBook'])) {
    ...
    $insertBookQry = "INSERT INTO b_books VALUES ('$book_id', '$title', '$auther', '$investigator', '$translator', '$publisher', '$publication_year', '$edition', '$quantity', '$purchase_price', '$sale_price', '$discount', '$status', '$creation_date', '$last_edit_date')";

    if (mysqli_query($conn, $insertBookQry)) {
        echo "<script>alert('تم إضافة الكتاب: $title بنجاح')</script>";
        echo '<script>window.location.href = "home.php#insertBook"</script>';
    } else {
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="number" class="form-control" name="publication_year"
                                        id="publication_year" placeholder="أدخل سنة النشر">
                                </div>
                                <div class="form-group col-md-2">
