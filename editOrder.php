    ...
    <div class="container-fluid mt-5 py-2">
        ...
        <div class="col-10 my_mr_sidebar pt-3">
            ...
            <form action="editOrder.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-1">
                    <div class="col-md-5">
                        <input list="books" value="<?php echo $row['title']; ?>" class="form-control" name="title"
                            id="title" required>
                        <datalist id="books">
                            <?php
                                //books List
                    ...
                    <div class="col-md-1">
                        <a class="btn btn-outline-danger"
                            href="delete.php?del_order_book_id=<?php echo $row['book_id'] ?>&title=<?php echo $row['title'] ?>&order_id=<?php echo $row['order_id'] ?>"
