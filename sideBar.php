...
?>
<!-- START Right column -->
<div class="col-2 my_fixed_sidebar py-2">
    <div class="nav flex-column nav-pills" id="myTab" role="tablist" aria-orientation="vertical">
        <!-- START Books section -->
        <li class="my_navList">الكتب</li>
        <a id="insertBook-tab" data-toggle="pill" data-toggle="pill" href="#insertBook" role="tab">
            <a class="nav-link" href="insertBook.php#insertBook">
        ...
        <a class="nav-link" id="Exhibition-tab" data-toggle="pill" href="#Exhibition" role="tab" aria-selected="false">
        ...
        <a class="nav-link" id="Dedicate-tab" data-toggle="pill" href="#Dedicate" role="tab" aria-selected="false">
        ...
        <a class="nav-link" id="stockReport-tab" data-toggle="pill" href="#stockReport" role="tab"
            aria-selected="false">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a class="nav-link" id="editStock-tab" data-toggle="pill" href="#editStock" role="tab" aria-selected="false">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a id="Dedicate-tab" data-toggle="pill" href="#logout" role="tab" aria-selected="false">
